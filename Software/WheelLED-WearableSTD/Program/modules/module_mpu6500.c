...
{
  SPIx_CS_L();
  SPI_RW8(SPIx, writeAddr);
  SPI_RW8(SPIx, writeData);
  SPIx_CS_H();
}
/*====================================================================================================*/
/*====================================================================================================*
...
uint8_t MPU6500_ReadReg( uint8_t readAddr )
{
  ...
  SPIx_CS_L();
  SPI_RW8(SPIx, 0x80 | readAddr);
  readData = SPI_RW8(SPIx, 0x00);
  SPIx_CS_H();
